...
edges = set()
with open('Edgelists/String_HPO_2015.phenotypic_branch.edgelist.txt', 'w') as outfile:
    for edge in G.edges:
        row = [edge[0], edge[1]]
        row.sort()
...
number_edge_list.num_edgelist('Edgelists/String_HPO_2015.phenotypic_branch.edgelist.txt',
                              'Edgelists/String_HPO_2015.phenotypic_branch.numbered.edgelist.txt',
                              'Edgelists/String_HPO_2015.phenotypic_branch.nodenames.txt')
...
# write to a file wile excluding duplicate edges (regardless of direction) and self loops
edges = set()
with open('Edgelists/String_HPO_2015.all_hpo.edgelist.txt', 'w') as outfile:
    for edge in G.edges:
        row = [edge[0], edge[1]]
        row.sort()
        if row[0] == row[1]: continue
...
number_edge_list.num_edgelist('Edgelists/String_HPO_2015.all_hpo.edgelist.txt',
                              'Edgelists/String_HPO_2015.all_hpo.numbered.edgelist.txt',
                              'Edgelists/String_HPO_2015.all_hpo.nodenames.txt')
